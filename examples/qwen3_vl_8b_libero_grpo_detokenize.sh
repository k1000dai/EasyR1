...
worker.reward.reward_function=./examples/reward_function/libero.py:compute_score \
trainer.experiment_name=qwen3_vl_8b_libero_fasttoken_grpo_kddi_detokenize \
